                ...
                .then(function(res){
                    ...
                    if(data.code == 0){
                        ...
                        for (var i in self.clllist){
                            ...
                            newaddtime.push(self.formate(self.clllist[i].timeSeries));
                        }
                        if(self.friendid.length - newaddtime.length == 0){
                            for(var i in self.clllist){
                                self.completelist.push(self.clllist[i].data);
                            }
                        }
                        else{
                            for(var i=0; i<self.friendlist.length - newaddtime.length; i++){
