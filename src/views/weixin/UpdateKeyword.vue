  ...
  data() {
    ...
    uploadaudio:function(val){
      ...
      onSubmit: function () {
        ...
        this.keywords.reply = JSON.stringify(this.keywords.reply)
        this.keywords.interval = Number.parseInt(this.keywords.interval)
        
        this.axios.post('/weixin/update_keyword_setting', this.keywords)
          .then(function(res){
              var data = res.data
              console.log(data)    
              if(data.code == 0){
      ...
      getupdateset: function () {
        var self = this
        this.axios.post('/weixin/get_keyword_setting', {id: this.id})
          .then(function(res){
              var data = res.data
              console.log(data)    
              if(data.code == 0){
